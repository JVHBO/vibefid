...
export default function FidCardMigrated() {
  ...
  const VMW_URL = `https://vibemostwanted.xyz/fid/${fid}`;
    ...
    <div className="min-h-screen bg-gradient-to-b from-vintage-charcoal to-vintage-deep-black flex items-center justify-center p-4">
      <div className="max-w-sm w-full text-center">
        ...
        <p className="text-vintage-ice/80 text-sm mb-2">
          Card FID #{fid} is now on <span className="text-vintage-gold font-bold">Vibe Most Wanted</span>.
        </p>
        ...
        <p className="text-vintage-ice/40 text-xs mt-6">vibemostwanted.xyz/fid/{fid}</p>
      </div>
    </div>
  );
}
